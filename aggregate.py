...
class Compiler(object):
    """The Compiler class is responsible for handling every stage of the aggregation.
    ...
    def generate_attrs(self, code):
        """Uses Regex to seperate package chains into lists containing Individual packages as Items.
    ...
    def hydrate_args(self, base_args, base_kwargs):
        ...
        Args:
            ...
            base_args: List of lists, contains kwarg name and default value.
